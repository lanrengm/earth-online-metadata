<script setup>
import { toolRoutes } from '../../router/index.js'
</script>

<template>
  <div>
    <h1 class="page-title">在线工具</h1>
    <p class="page-sub">免费、纯本地计算、无需登录的小工具合集</p>
    <div class="tool-grid">
      <RouterLink
        v-for="t in toolRoutes"
        :key="t.path"
        :to="t.path"
...
.page-sub { color: var(--on-surface-variant); margin: 8px 0 24px; }
